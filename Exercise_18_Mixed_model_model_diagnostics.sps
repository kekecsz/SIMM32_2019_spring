...
MIXED wound_healing BY south_wing WITH distance_window time_centered time_centered_sq
  /CRITERIA=CIN(95) MXITER(100) MXSTEP(10) SCORING(1) SINGULAR(0.000000000001) HCONVERGE(0, 
    ABSOLUTE) LCONVERGE(0, ABSOLUTE) PCONVERGE(0.000001, ABSOLUTE)
  /FIXED=south_wing distance_window time_centered time_centered_sq | SSTYPE(3)
  /METHOD=REML
  /PRINT=SOLUTION
...
*Investigate linearity using the residuals and the predicted values plot.
GGRAPH 
